...
term:
  ...
  | tm = arrow
    { tm }
  | ELIM; scrut = term; AT; x = name; RIGHT_ARROW; mot = term; LSQ; ZERO; RIGHT_ARROW; zero = term; PIPE; SUC; n = name; ih = name; RIGHT_ARROW; suc = term; RSQ
    { NatElim {zero ; suc = (n,ih,suc) ; scrut ; mot = (x,mot)} }
